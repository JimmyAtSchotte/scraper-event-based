...
crawler.StatusChanged += (sender, status) => Console.WriteLine($"Page scraped: {status.Completed}");
crawler.PageScraped += (sender, page) => Console.WriteLine("Page scraped event");
